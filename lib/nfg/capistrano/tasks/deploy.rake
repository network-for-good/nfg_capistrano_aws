...
namespace :deploy do
  ...
  task :compile_assets => [:set_rails_env] do
    ...
    begin
      ...
      Airbrussh::Colors.green("Downloading #{assets_filename} from #{s3_bucket}")
      ...
      Airbrussh::Colors.red("Compiling assets manually since #{assets_filename} does not exist in #{s3_bucket}")
